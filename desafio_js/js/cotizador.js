...
// resive un escuchador y la funcion de los calculos 
   ...
   if (s_seguir =="S"){
      ...
      /*
        for(var i=0;i<lista_productos.length ;i++){
           ...
           // div_resumen.textContent = String(lista_productos[i])
           // al div le voy a insertar un ul, y luego un li por cada item de lista
            // antes de crear el elemento me fijo si existe el li y piso el contenido
